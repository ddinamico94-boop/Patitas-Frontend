...
export default function Register({
  ...
  async function handleSubmit() {
    ...
    try {
      ...
      /*
       * Si el usuario llegó al registro desde
       * "Reportar animal", vuelve automáticamente
       * al formulario.
       */
      const returnPage =
      ...
      if (returnPage === 'create-report') {
        navigate('create-report');
        return;
      }

      /*
       * Comportamiento normal del registro.
       */
      navigate('profile');
    } catch (err) {
      setError(
    ...
    <div className="bg-cream min-h-full flex items-center justify-center p-6 sm:p-10 py-12">
      ...
      <div className="w-full max-w-md">
        <button
          ...
          className="flex items-center gap-2.5 text-terra mb-8"
        >
          <img
            src={icon}
            alt="Patitas Tucumán"
        ...
        <p className="text-warm-mid mb-8">
          Unite a la comunidad que cuida a los animales de Tucumán.
        </p>
